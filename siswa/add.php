  ...
  <div class="row justify-content-center">
    <div class="col-12 col-sm-10 col-lg-8 mt-4 mb-5">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="mt-3 mb-5 text-center">TAMBAH SISWA</h2>
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" name="no_telepon" placeholder="Masukkan No HP" required>
            </div>
            <div class="mb-3">
