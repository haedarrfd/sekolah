  ...
  <div class="row justify-content-center">
    <div class="col-12 col-sm-10 col-lg-8 mt-4 mb-5">
      <div class="card shadow-sm">
        <div class="card-body">
          <h2 class="mt-3 mb-5 text-center">EDIT NILAI</h2>
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="mb-3">
              <label class="form-label">Kode Nilai</label>
              <input type="text" class="form-control" name="kd_nilai" value="<?= $row['kd_nilai'] ?>" placeholder="Masukkan Kode Nilai" required readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" name="kd_matpel" required>
                <option value="<?= $row['kd_matpel'] ?>"><?= $row['kd_matpel'] ?></option>
                <?php
                include_once "../connection.php";
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="nilai_p" value="<?= $row['nilai_p'] ?>" placeholder="Masukkan Nilai Pelajaran" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Nilai Kompetensi</label>
              <input type="text" class="form-control" name="nilai_k" value="<?= $row['nilai_k'] ?>" placeholder="Masukkan Nilai Kompetensi" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="tapel" value="<?= $row['tapel'] ?>" placeholder="Masukkan Tahun Pelajaran" required>
            </div>
